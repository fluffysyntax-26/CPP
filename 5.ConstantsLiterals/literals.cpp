...
int main(){ 
    /* 
    The value of the literals is burned into the binary of the code, the values of the variables are not loaded into memory 
    instead they're directly used. this allows for faster and efficient execution
    */
