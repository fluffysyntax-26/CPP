...
/* 
constinit means that the initalisation is done at compile time instead of runtime, it is done to resolve issues before the main fucntion is executed
constinit has no value in the main function so it raises a compiler error
*/
const int val1 {33};
